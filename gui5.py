...
class lookup_gui(Frame):
    ...
    def makeWidgets(self):
        ...
        # This for loop makes text fields for each fieldname
        for index, value in enumerate(fieldnames):
            ...
            # these text fields are recorded in the entries dict
    ...
    def fetchRecord(self):
        # Loopup in csv and get that players data
        # Data is displayed in the appropriate text field
